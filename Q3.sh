...
specialCount=$(echo $string | grep -o  "[@#!$%^&*()-/\|]" | wc --lines)

echo "The given string has $vowCount vowels, $consCount consonants , $specialCount  special  and $numCount numbers in it."
